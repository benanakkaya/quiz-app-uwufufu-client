...
const SearchBox = ({ setSearchBoxVisibility }) => {
  ...
  return (
    <div className="bg-customDark z-30 absolute top-full mt-1 py-6  w-full  border-b-[1px] border-b-customGray  ">
      <div className="container flex items-center justify-center gap-3 px-6 sm:px-8 md:px-10 lg:px-12">
