      ...
      <div className="col-span-5 flex flex-col gap-4 flex-1 ">
        ...
        <div className="flex flex-col gap-2 text-customLightGray ">
          ...
          <progress
            ...
            className="w-full [&::-webkit-progress-bar]:rounded-lg [&::-webkit-progress-value]:rounded-lg   [&::-webkit-progress-bar]:bg-customGray [&::-webkit-progress-value]:bg-blue-400 [&::-moz-progress-bar]:bg-blue-400 w-96 "
          />
